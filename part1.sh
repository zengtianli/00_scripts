...
mkdir -p ../processed_data/csv_sections
echo "🔍 Finding and copying relevant .csv files..."
find ../processed_data/csv_files/ -name '*断面测量数据表.csv' | xargs -I {} cp {} ../processed_data/csv_sections
...
echo "✅ Script execution completed! save as chainage.csv in processed_data directory."
